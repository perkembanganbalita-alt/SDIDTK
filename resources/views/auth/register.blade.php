            ...
            <form class="space-y-4" action="{{ route('register') }}" method="POST">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="name" name="name" type="text" required class="appearance-none rounded-lg relative block w-full pl-10 px-4 py-2.5 border border-slate-200 placeholder-slate-400 text-slate-900 focus:outline-none focus:ring-2 focus:ring-[#4CA861] focus:border-[#4CA861] focus:z-10 sm:text-sm transition-all shadow-sm" placeholder="Masukkan username Anda" value="{{ old('name') }}">
                    </div>
                    @error('name')
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="email" name="email" type="email" required class="appearance-none rounded-lg relative block w-full pl-10 px-4 py-2.5 border border-slate-200 placeholder-slate-400 text-slate-900 focus:outline-none focus:ring-2 focus:ring-[#4CA861] focus:border-[#4CA861] focus:z-10 sm:text-sm transition-all shadow-sm" placeholder="Masukkan email Anda" value="{{ old('email') }}">
                    </div>
                    @error('email')
                        <p class="mt-1 text-xs text-danger">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <div class="relative" x-data="{ show: false }">
                        ...
                        <input id="password" name="password" :type="show ? 'text' : 'password'" required minlength="8" class="appearance-none rounded-lg relative block w-full pl-10 pr-10 px-4 py-2.5 border border-slate-200 placeholder-slate-400 text-slate-900 focus:outline-none focus:ring-2 focus:ring-[#4CA861] focus:border-[#4CA861] focus:z-10 sm:text-sm transition-all shadow-sm" placeholder="Minimal 8 karakter">
