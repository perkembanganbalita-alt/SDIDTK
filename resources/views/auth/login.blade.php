            ...
            <form class="space-y-5" action="{{ route('login') }}" method="POST">
                ...
                <div>
                    ...
                    <div class="relative" x-data="{ show: false }">
                        ...
                        <input id="password" name="password" :type="show ? 'text' : 'password'" autocomplete="current-password" required class="appearance-none rounded-lg relative block w-full pl-4 pr-10 py-3 border border-slate-200 placeholder-slate-400 text-slate-900 focus:outline-none focus:ring-2 focus:ring-[#4CA861] focus:border-[#4CA861] sm:text-sm transition-all shadow-sm" placeholder="Masukkan password Anda">
                ...
                <div class="flex items-center justify-between mt-4">
                    ...
                    <div class="text-sm">
                        <a href="{{ route('password.request') }}" class="font-medium text-[#4CA861] hover:text-[#3a834c] transition">Lupa Password?</a>
                    </div>
                </div>
