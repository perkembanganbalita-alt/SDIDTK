...
<body class="text-slate-800 antialiased h-screen flex overflow-hidden bg-background" x-data="{ sidebarOpen: false }">
    @auth
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
               class="fixed inset-y-0 left-0 w-64 bg-white border-r border-slate-100 flex flex-col h-full z-40 shadow-sm transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:z-20">
